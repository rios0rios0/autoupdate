#!/bin/sh
#
# AutoUpdate Installation Script
#
# Downloads and installs autoupdate from GitHub releases.
...
#   AUTOUPDATE_INSTALL_DIR   Installation directory (default: ~/.local/bin)
#   AUTOUPDATE_VERSION       Specific version to install (default: latest)
#   AUTOUPDATE_FORCE         Force installation (true/false, default: false)
#   AUTOUPDATE_DRY_RUN       Dry run mode (true/false, default: false)
#
...
BINARY_NAME="autoupdate"

# Defaults
DEFAULT_INSTALL_DIR="$HOME/.local/bin"
INSTALL_DIR="${AUTOUPDATE_INSTALL_DIR:-$DEFAULT_INSTALL_DIR}"
VERSION="${AUTOUPDATE_VERSION:-latest}"
FORCE="${AUTOUPDATE_FORCE:-false}"
DRY_RUN="${AUTOUPDATE_DRY_RUN:-false}"
...
ENVIRONMENT VARIABLES:
    AUTOUPDATE_INSTALL_DIR   Installation directory
    AUTOUPDATE_VERSION       Specific version to install (default: latest)
    AUTOUPDATE_FORCE         Force installation (true/false)
    AUTOUPDATE_DRY_RUN       Dry run mode (true/false)
